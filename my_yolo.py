...
class MyYolo:
    ...
    # constants
    NAMES_FILE = 'E:/our yolo v3/model/classes.names'
    WEIGHTS_FILE = 'E:/our yolo v3/model/yolov3_custom_last.weights'
    CFG_FILE = 'E:/our yolo v3/model/yolov3_custom.cfg'
    
    
    def __init__(self, model_path, min_confidence=0.5, nms_thresh=0.1,
                 object_names=None):
        """
